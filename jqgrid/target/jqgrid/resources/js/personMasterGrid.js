					...
					.jqGrid(
							{
								...
								colModel : [
										...
										},
										{
											...
											formatter: function (cellvalue, options, rowObject) {
					                            ...
					                            return '<span class="cellWithoutBackground" style="background-color:' + color + ';">' + cellPrefix + cellvalue + '</span>';
					                        },
											editrules : {
					            ...
					            subGridRowExpanded: function(subgrid_id, row_id) {
					            	var personName = $('#myGrid').jqGrid('getCell', row_id, 'personName');
					            	var personBirthDate = $('#myGrid').jqGrid('getCell', row_id, 'personBirthDate');
					            	var personEmailId = $('#myGrid').jqGrid('getCell', row_id, 'personEmailId');
					            	var personMobileNumber = $('#myGrid').jqGrid('getCell', row_id, 'personMobileNumber');
					            	var personDesignation = $('#myGrid').jqGrid('getCell', row_id, 'personDesignation');
					            	var personState = $('#myGrid').jqGrid('getCell', row_id, 'personState');
					            	var personCity = $('#myGrid').jqGrid('getCell', row_id, 'personCity');
					            	var personGender = $('#myGrid').jqGrid('getCell', row_id, 'personGender');
					            	var personPostalCode = $('#myGrid').jqGrid('getCell', row_id, 'personPostalCode');
					            	var personGitUrl = $('#myGrid').jqGrid('getCell', row_id, 'personGitUrl');
					            	var personSkills = $('#myGrid').jqGrid('getCell', row_id, 'personSkills');
					            	var personProjectValue = $('#myGrid').jqGrid('getCell', row_id, 'personProjectValue');
								...
								loadComplete : function() {
				                    ...
				                    $('#myGrid').jqGrid('setCell',"12","personName","",{color:'red'});
				                    $('#myGrid').jqGrid('setCell',"12",'personBirthDate', '', 'my-highlight');

				                    $('#myGrid').jqGrid('setCell',"12","personMobileNumber","",{'background-color':'yellow', 'background-image':'none'});
				                    $('#myGrid').jqGrid('setCell',"12","personEmailId","",'ui-state-highlight');
